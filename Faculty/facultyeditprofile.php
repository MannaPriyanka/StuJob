				...
				<div class="sidebar">
					...
					<div class="widget user">
						...
						<div class="image d-flex justify-content-center">
							<img src="images/user/user-thumb.jpg" alt="" class=" d-inline-flex">
						...
						<center>
									...
									<input type="file" class="form-control-file mt-2 pt-1" id="input-file" name= "image"></div>
									<div class="form-group choose-file d-inline-flex">
									<input type="submit" class ="btn btn-transparent" value = "change" name="submit"></div>
								</center>
								 </form>
						<!-- User Name -->
			...
			<div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
							...
							<form action="facultyeditp.php" method="post" enctype="multipart/form-data">
								<!-- First Name -->
						...
						<div class="widget personal-info">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control"  name="fcollege" required>
								</div>
								<div class="form-group">
									<label for="last-name">designation</label>
									<input type="text" class="form-control"  name="fpost"  required>
								</div>
								<div class="form-group">
									<label for="last-name">Department</label>
									<input type="text" class="form-control" name="fdepartment" required>
								</div>
								<div class="form-group">
