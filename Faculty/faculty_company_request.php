...
<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
  ...
  <div class="widget dashboard-container my-adslist">
    <h3 class="widget-header">Wokrshop</h3>
    ...
    <div class="block">
      ...
      <table class="table-bordered">
        ...
        $sql = "SELECT * FROM workshops LEFT JOIN company on company.cid = workshops.c_id";
        ...
        ?>
          ...
          <tr>
            ...
            <td><a href="../company/uploads/<?php echo $row['workshop_file'] ?>" class="btn btn-main-sm"> view </a>
            <br><br>
              <a href="mailto: <?php echo $row['cemail']; ?>" class="btn btn-main-sm"> mail </a>
