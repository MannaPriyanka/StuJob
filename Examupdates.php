      ...
      <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-profile">
			...
			<a href="viewstudentprofile.php" class="btn btn-main-sm">View Profile</a>

            <a href="studentprofile.php" class="btn btn-main-sm">Edit Profile</a>
          </div>
          <!-- Dashboard Links -->
          <div class="widget user-dashboard-menu">
            <ul>
              ...
              <li><a href="dashboard-pending-ads.html"><i class="fa fa-bolt"></i> Exam Time Table<span>23</span></a></li>
              <li><a href="dashboard-pending-ads.html"><i class="fa fa-bolt"></i>  Exam Marks<span>23</span></a></li>
              <li><a href="dashboard-pending-ads.html"><i class="fa fa-bolt"></i>  Exam Syllabus<span>23</span></a></li>
