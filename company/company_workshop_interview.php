...
<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
  <div class="container">
    <form action="arrangeworkshops.php" method="post" enctype="multipart/form-data">
      <!-- Post Your ad start -->
      <fieldset class="border border-gary p-4 mb-5">
        <div class="row">
          <div class="col-lg-12">
            <h3>Arrange Workshop</h3>
          </div>
          ...
          <div class="col-lg-6">
            ...
            <h6 class="font-weight-bold pt-4 pb-1">Speaker :</h6>
            <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="(Speaker/ Facilitator name)" name="speaker">

            <h6 class="font-weight-bold pt-4 pb-1">Date :</h6>
            <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="(starting date-ending year/ month/ date)" name="date">

            <h6 class="font-weight-bold pt-4 pb-1">Time :</h6>
            <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="(starting time-ending time/ am-pm)" name="time">

            <h6 class="font-weight-bold pt-4 pb-1">Venue :</h6>
            <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="(Enter Address)" name="venue">

            <h6 class="font-weight-bold pt-4 pb-1">Description:</h6>
            <textarea id="" class="border p-3 w-100" rows="7" placeholder="Write details about your workshop " name="discription"></textarea>
          </div>
          <div class="col-lg-6">
            <h6 class="font-weight-bold pt-4 pb-1">Eligibility :</h6>
            <select name="eligibility" id="inputGroupSelect" class="w-100">
      ...
      <button type="submit" class="btn btn-primary d-block mt-2" name="post">Arrange</button>
    </form>
  </div>
  </section>
  >
