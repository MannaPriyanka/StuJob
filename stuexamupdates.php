    ...
    <div class="row">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li><a href="Studentdashboard.php"><i class="fa fa-user"></i> My Dashboard</a></li>
               <li><a href="studentplacement.php"><i class="fa fa-bolt"></i>Placement Updates</a></li>
              <li><a href="viewcompany.php"><i class="fa fa-bolt"></i> View Company</a></li>
              <li class="active"><a href="stuexamupdates.php"><i class="fa fa-bolt"></i>Exam Updates</a></li>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Placement Test Timetable</h3>
         <a href="StuExamTimeTable.php" class="btn btn-main-sm">View Timetable</a>

		  </div>
		  
		  <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Placement Test Syllabus</h3>
         <a href="Studentexamsyllabus.php" class="btn btn-main-sm">View  Syllabus</a>

		  </div>
		  <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Placement Test Marks</h3>
