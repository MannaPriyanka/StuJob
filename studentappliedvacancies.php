    ...
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-profile">
            ...
            <!-- User Name -->
            <h5 class="text-center"><?php  echo $user; ?></h5>
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li><a href="Facultydashboard.php"><i class="fa fa-user"></i> My Dashboard</a></li>
              <li><a href="approvestudents.php"><i class="fa fa-file-archive-o"></i>Approve Students</a></li>
              <li class="active"><a href="faculty_placement.html"><i class="fa fa-file-archive-o"></i>Placement Updates</a></li>
			<li><a href="faculty_company_request.html"><i class="fa fa-bolt"></i>Company Requests</a></li>
	  ...
	  <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Applied Student</h3>
		          <div class="widget dashboard-container my-adslist">
		  ...
		  <div class="block">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-3">
							<ul class="store-list">
				<li><?php echo"<b>Student name<b><br>".$s_name;?></li>
				<li><?php echo"<br><b>Company name<b><br>".$c_name;?></li>
				<li><?php echo"<br><b>Post Vacancies<b><br>".$vac_title;?></li>
						...
						<div class="col-md-6 col-sm-3">
							<ul class="store-list">
							<form method="get" action="flistapprov.php">
						<input type="hidden" name="id" value="<?php echo $t_id;?>">
						<input type="submit" value="approve"  class=" btn btn-main-sm" name="approve">
						</form>
						
							<form method="get" action="listreject.php"> 
							<input type="hidden" name="id" value="<?php echo $t_id;?>">
						<input type="submit" value="reject"  class=" btn btn-main-sm" name="reject">
						</form>
							</ul>
