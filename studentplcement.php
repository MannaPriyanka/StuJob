...
<head>
  ...
  <title>Student Exam Updates</title>
    ...
    <div class="row">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li><a href="Studentdashboard.php"><i class="fa fa-user"></i> My Dashboard</a></li>
               <li class="active"><a href="studentplacement.php"><i class="fa fa-bolt"></i>Placement Updates<span>23</span></a></li>
              <li><a href="viewcompany.php"><i class="fa fa-bolt"></i> View Company<span>23</span></a></li>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Exam Timetable</h3>
         <a href="StuExamTimeTable.php" class="btn btn-main-sm">View Exam Timetable</a>

		  </div>
		  
		  <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Exam Syllabus</h3>
         <a href="Studentexamsyllabus.php" class="btn btn-main-sm">View Exam Syllabus</a>

		  </div>
		  <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Exam Marks</h3>
         <a href="Stuexammarks.php" class="btn btn-main-sm">View Exam Marks</a>
