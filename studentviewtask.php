        ...
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              ...
              <li><a href="StuExamTimeTable.php"><i class="fa fa-bolt"></i> Exam Time Table<span>23</span></a></li>
              <li><a href="Stuexammarks.php"><i class="fa fa-bolt"></i>  Exam Marks<span>23</span></a></li>
              <li><a href="Studentexamsyllabus.php"><i class="fa fa-bolt"></i>  Exam Syllabus<span>23</span></a></li>
