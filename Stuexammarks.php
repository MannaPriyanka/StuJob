...
?>
		...
		<div class="widget dashboard-container my-adslist">
          ...
          <h3 class="widget-header"> Marks</h3>
...
<div class="block">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6">
							<ul class="store-list">
									<li><b>Time Table</b><br></a></li>
															 <td><a href="uploads/img10.jpg" >download</a></td>
						...
						<div class="col-md-3 col-sm-6">
							...
							<ul class="store-list">
							<li><?php echo "<b>semester</b><br> ".$sem?></li>
